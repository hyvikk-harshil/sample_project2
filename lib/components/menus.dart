    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          actions: const <Widget>[MenuExample()],
        ),
      ),
    );  }
}
...
class _MenuExampleState extends State<MenuExample> {
  ...
  Widget build(BuildContext context) {
    return MenuAnchor(
      ...
      menuChildren: [
        MenuItemButton(onPressed: (){},child: Text("Revert"),),
        MenuItemButton(onPressed: (){},child: Text("Setting"),),
        MenuItemButton(onPressed: (){},child: Text("Send FeedBack"),),
        SubmenuButton(
          animated: true,
          menuChildren: <Widget>[
            MenuItemButton(
...
class Menu2 extends StatelessWidget {
  ...
  static const String kMSG = "Talk lesss....Smile More....";
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: Scaffold(
        body: MenuExample2(massage:kMSG),
      ),
    );
  }
}
class MenuExample2 extends StatefulWidget {
  MenuExample2({super.key, required this.massage});
  String massage;
  @override
  State<MenuExample2> createState() => _MenuExample2State();
}
class _MenuExample2State extends State<MenuExample2> {
  ...
  @override
  Widget build(BuildContext context) {
    return Padding(padding: const .all(50),
