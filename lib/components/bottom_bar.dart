...
class BottomAppBarDemo2 extends StatefulWidget {
  ...
  @override
  State createState() => _BottomAppBarDemoState2();
}
class _BottomAppBarDemoState2 extends State<BottomAppBarDemo2> {
...
class _DemoBottomAppBar2 extends StatelessWidget {
  const _DemoBottomAppBar2({required this.isElevated, required this.isVisible});
