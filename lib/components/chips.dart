...
class ExampleChips extends StatefulWidget {
  const ExampleChips({super.key});

  @override
  State<ExampleChips> createState() => _ExampleChipsState();
}
class _ExampleChipsState extends State<ExampleChips> {
  @override
...
///Input-chip
class ChipExample1 extends StatefulWidget {
  const ChipExample1({super.key});
  @override
  State<ChipExample1> createState() => _ChipExample1State();
}
class _ChipExample1State extends State<ChipExample1> {
  int inputs = 3;
  int? selectedIndex;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title:Text("InputChip Sample"),),
      body: Center(
        child: Column(
          ...
          children: [
            Wrap(
              //alignment: .center,
              spacing: 05.0,
              children: List.generate(inputs, (int index){
              return InputChip(
